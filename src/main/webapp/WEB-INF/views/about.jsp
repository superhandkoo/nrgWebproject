	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="active"><a href="/nrg/about.do"><span class="glyphicon glyphicon-question-sign"></span> 关于我们</a></li>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9 about">
				<a name="1" ></a>
				<h3>机构简介</h3>
				<p> 瑞兰德环境科技有限公司是一家专业以智能化弱电工程为主的高科技民营企业，公司自创立以来一直专业致力于智能化弱电工程；始终坚持发扬"诚信、创新、沟通"为企业宗旨，以"技术、服务"为立业之本的团体精神，并形成一套完整的设计、安装、调试、培训、维护一站式服务体系。</p>
				<a name="2" ></a>
				<h3>加入我们</h3>
