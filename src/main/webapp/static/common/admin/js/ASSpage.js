...
function goPage(pageNum) {
	...
	$("#pageCurrentPage1").val(pageNum);
	var url=document.searchForm.action;
	url=url.substring(0,url.length-1);
	var newurl=url+pageNum;
	document.searchForm.action=newurl;
	$("#searchForm").submit();
}
...
function showPageNumber() {
	...
	pageHtml = pageHtml + '<li class="disabled"><a href="javascript:void(0)" style="background-color:#ddd;color: #000;">' + currentPage + '</a></li>';
